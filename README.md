...
Currently we test using `0.11.0-dev.1507+6f13a725a`. Newer is generally better, but you can download this version here:

- **linux-x86_64**: https://ziglang.org/builds/zig-linux-x86_64-0.11.0-dev.1507+6f13a725a.tar.xz)
- **windows-x86_64**: https://ziglang.org/builds/zig-windows-x86_64-0.11.0-dev.1507+6f13a725a.zip
- **macos-x86_64** (Intel): https://ziglang.org/builds/zig-macos-x86_64-0.11.0-dev.1507+6f13a725a.tar.xz
- **macos-aarch64** (Apple Silicon): https://ziglang.org/builds/zig-macos-aarch64-0.11.0-dev.1507+6f13a725a.tar.xz
